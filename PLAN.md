...
| 2026-07-31 | `feat/ppocr-next-20260731` | **Picked:** O11.5 backend build/device matrix: Metal macOS, CUDA Linux, CPU reference; graph-compute smoke now accepts an explicit backend argument and reports requested/selected device | **IN PROGRESS** |
