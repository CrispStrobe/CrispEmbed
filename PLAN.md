...
|-------|-------------------|------|--------|
| 2026-08-07 | `fix/pix2struct-enc-parity` | **Claimed: pix2struct encoder parity bisect** (residual caption drift vs HF, f16==q8 ⇒ not quant). Stage (i) patch preprocessing vs HF `flattened_patches`, stage (ii) encoder outputs; GLM bisect method | **IN PROGRESS** |
