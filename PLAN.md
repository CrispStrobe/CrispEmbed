...
|-------|-------------------|------|--------|
| 2026-08-07 | *(artifacts + registry, small branch)* | **Claimed (pix2struct follow-up): convert google/pix2struct-textcaps-base** — the promptless finetuned variant (docvqa needs a rendered question the port lacks); f16 + q8_0, decode validation with the new detok, model_mgr registry entry, HF upload | **IN PROGRESS** |
