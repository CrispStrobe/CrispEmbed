...
|-------|-------------------|------|--------|
| 2026-08-02 | `feat/easyocr-ggml` / `.codex/worktrees/feat-easyocr-ggml` | **Picked:** validate the opt-in Tesseract DAWG prefix scorer after the remote recoder merge; fix intermediate legal-prefix ranking and token-text word boundaries, with focused contract tests and no production dictionary scoring | **COMPLETED** |
...
| 2026-08-02 | `feat/ppocr-next-20260731` | **Picked:** add reusable Metal pipeline/cache timing and dynamic-width gold logits, then benchmark warm 320/384-width recognizer graphs; do not promote Metal acceptance until cold/warm cost and numerical parity are recorded | **IN PROGRESS** |
