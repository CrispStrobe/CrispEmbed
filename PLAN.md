...
- [x] **#4 Converter-emitted stacked experts (memory) — DONE
  ...
  decoded output identical on all 3 loader paths.** Registry promotion to
  stacked-default awaits user sign-off (outward-facing). Deep-dive in LEARNINGS.
