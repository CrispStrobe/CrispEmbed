...
|-------|-------------------|------|--------|
| 2026-08-06 | `fix/pageseg-round2` / `.claude/worktrees/fix-pageseg-r2` | **Claimed (pageseg round 2): the truncated-row residual** — the split-band x-tightening (`column_ink>=4`) clips a continuation row's tail mid-word (round-1 crop-04); fix the bound, re-measure Fraktur CER (round-1 landed at 0.271; target ≤0.25 this increment), arms + synthetic/CC0 identity gates as in round 1 | IN PROGRESS |
