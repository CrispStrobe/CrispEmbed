...
|-------|-------------------|------|--------|
| 2026-08-06 | `fix/pageseg-quality` / `.claude/worktrees/fix-pageseg-quality` | **Claimed (Fable task 4): Tesseract pageseg quality lane** — close the classical route's CER 0.412 toward the dbnet route's 0.235 (crop geometry vs official PSM crops, recoder/decoder semantics) on the existing quality-gate fixtures; the 1.2 s speed must hold | IN PROGRESS |
