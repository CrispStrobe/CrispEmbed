...
| 2026-07-31 | `feat/ppocr-next-20260731` | **Picked:** O11.6 graph performance/parity gates: backend smoke now records warm compute latency after a successful graph run; engine-level parity/quality gates remain pending. Added opt-in per-line recognizer graph timing; Metal detector diagnostic is ~3.5 s on the German CC0 page and remains CPU-accepted until probability-map parity improves (0.99114 cosine) | **IN PROGRESS** |
