...
| N3 | OCR perf H-items: H2 detector scalar path, H4 batched crops, H5 tesseract load, H6 resize-by-text-height. H1/H3/H7 landed. Brief + measurement rules in §"OCR performance — self-contained handover prompts" | `perf/ocr-h-items` |
