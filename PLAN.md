...
| 2026-07-13 | `feat/flova-regression-fixture` | Flova OMR regression fixture (manifest entry + `staff_flova.png`) | **DONE — validated, pending push to `main`.** `run_one.py --name flova` PASS (garbage-guard + text cer 0.000 vs q8_0 pulled from `cstr/flova-omr-GGUF`, CPU==Metal). |
