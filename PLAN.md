...
|-------|-------------------|------|--------|
| 2026-07-15 | `chore/pub-crispembed-dart` (`../CrispEmbed-pub`) | Prepare/publish Dart FFI package to pub.dev | **IN PROGRESS** — `crispembed` name is free; package metadata/docs added; `flutter analyze` passes; dry-run has only dirty-tree warning. |
