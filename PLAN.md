...
|-------|-------------------|------|--------|
| 2026-07-15 | `chore/pub-crispembed-dart` (`../CrispEmbed-pub`) | Prepare/publish Dart FFI package to pub.dev | **IN PROGRESS** — clean worktree from `origin/main`; inspecting metadata and package name availability. |
