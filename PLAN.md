...
| 2026-07-13 | `feat/flova-omr` | Flova/omr_transformer — handwritten/whiteboard OMR (donut-swin + mBART VED → LilyPond, Apache-2.0) | 🔄 **Foundation on `main`** — converter (484 tensors), dumper (12-stage oracle), ABI header, handover brief (`docs/flova-engine-handover.md`). **Pending: `src/flova_ocr.cpp`** — DonutSwin encoder (copy `mixtex_ocr` Swin, change config) + mBART pre-norm decoder. eos=54 landmine resolved. |
