...
| 2026-08-08 | `feat/embed-language-matrix` / `.claude/worktrees/embed-lang` | **Claimed (E5+E6+E1):** WordPiece CJK tokenizer parity (E5), runtime unknown-token warning (E6), finish JA embedder matrix for 7 untested aliases (E1). CPU-only VPS work. | **IN PROGRESS — starting E5** |
