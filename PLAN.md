...
| 2026-08-01 | `feat/tesseract-fraktur` / `/Volumes/backups/code/CrispEmbed-tesseract-fraktur` | **Picked:** port a Tesseract-native classical page-segmentation path for Fraktur, retaining DBNet behind an explicit fallback gate; compare region geometry, text quality, and end-to-end latency | **IN PROGRESS — DBNet remains default; segmentation port not started** |
