...
|-------|-------------------|------|--------|
| 2026-08-02 | `feat/easyocr-ggml` / `.codex/worktrees/feat-easyocr-ggml` | **Picked:** validate the opt-in Tesseract DAWG prefix scorer after the remote recoder merge; fix intermediate legal-prefix ranking and add a focused contract test, without enabling production dictionary scoring | **COMPLETED** |
