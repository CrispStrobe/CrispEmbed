...
`"The quick brown fox jumps over the lazy dog. 12345"` on **f16 and q8_0, CPU
...
### q8_0: dequantize BEFORE reshaping (same class as got-ocr `11c2bc7`)

q8_0 produced garbage embeds on CPU *and* hit the Metal
...
fine (dequant vs f16 = cos 0.99997) — the gguf was not corrupt.
